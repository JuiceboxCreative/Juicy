...
!function(a) {
    ...
    if (a(".map").length) {
        ...
        b.type = "text/javascript", b.src = "http://maps.googleapis.com/maps/api/js?key=AIzaSyDBkfJltZseT_Mjjm4kTFBrAw2LKN-s5gk&sensor=false&callback=createMap", 
        document.body.appendChild(b);
    }
}), jQuery(document).ready(function() {
    jQuery(".hamburger").on("click", function() {
        jQuery(this).toggleClass("is-active"), jQuery(".main-navigation").toggleClass("is-active");
    });
});